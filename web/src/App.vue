...
import { NConfigProvider, NButton, NIcon, NDropdown, NMenu, darkTheme } from "naive-ui";
...
import type { FlowNodeData } from "./components/FlowNode.vue";
...
function onNodeEdit(nodeId: string) {
  nextTick(() => fitView({ nodes: [nodeId], padding: 0.3, duration: 300 }));
}
...
const addNodeOptions: DropdownOption[] = [
  {
    label: "添加场景",
    key: "scene",
    type: "group",
    children: [
      { label: "开始", key: "scene-start" },
      { label: "结束", key: "scene-end" },
